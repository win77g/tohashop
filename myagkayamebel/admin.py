...
class MyagkayamebelImageInline(admin.TabularInline):
    model = MyagkayamebelImage
    extra = 1
    list_display = ['image_img',]
    readonly_fields = ['image_img',]
# ---------------------------- end Gallery----------------------------------------------------------
class MyagkayamebelModelAdmin (admin.ModelAdmin):
   #  вывод всех полей в админку
   #    list_display = [field.name for field in Product._meta.fields]
   inlines = [MyagkayamebelImageInline,]
...
# Register your models here.
admin.site.register(MyagkayamebelModel,MyagkayamebelModelAdmin)
