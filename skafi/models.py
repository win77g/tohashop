...
class SkafModel(models.Model):
    ...
    price_g450_st = models.DecimalField(max_digits=10, decimal_places=2, default=0,verbose_name='Цена ш450st')
    price_g450_od = models.DecimalField(max_digits=10, decimal_places=2, default=0,verbose_name='Цена ш450od ')
    price_g600_st = models.DecimalField(max_digits=10, decimal_places=2, default=0,verbose_name='Цена ш600st')
    price_g600_od = models.DecimalField(max_digits=10, decimal_places=2, default=0,verbose_name='Цена ш600od ')
