...
class DetskieImageInline(admin.TabularInline):
    model = DetskieImage
    extra = 1
    list_display = ['image_img',]
    readonly_fields = ['image_img',]
# ---------------------------- end Gallery----------------------------------------------------------
class DetskieModelAdmin (admin.ModelAdmin):
   #  вывод всех полей в админку
   #    list_display = [field.name for field in Product._meta.fields]
   inlines = [DetskieImageInline,]
...
# Register your models here.
admin.site.register(DetskieModel,DetskieModelAdmin)
