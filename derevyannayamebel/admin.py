...
class DerevyannayamebelImageInline(admin.TabularInline):
    model = DerevyannayamebelImage
    extra = 1
    list_display = ['image_img',]
    readonly_fields = ['image_img',]
# ---------------------------- end Gallery----------------------------------------------------------
class DerevyannayamebelModelAdmin (admin.ModelAdmin):
   #  вывод всех полей в админку
   #    list_display = [field.name for field in Product._meta.fields]
   inlines = [DerevyannayamebelImageInline,]
...
# Register your models here.
admin.site.register(DerevyannayamebelModel,DerevyannayamebelModelAdmin)
