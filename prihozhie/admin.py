...
# ---------------------------- end Gallery----------------------------------------------------------
class PrihozhieModelAdmin (admin.ModelAdmin):
   #  вывод всех полей в админку
   #    list_display = [field.name for field in Product._meta.fields]
   inlines = [PrihozhieImageInline,]
   list_display = ('name','brend','category','podcateg','image_img','photoMenu', 'price','is_active','new_product','top','slider')
   readonly_fields = ['image_img',]
...
# Register your models here.
admin.site.register(PrihozhieModel,PrihozhieModelAdmin)
