...
class SpalniImageInline(admin.TabularInline):
    model = SpalniImage
    extra = 1
    list_display = ['image_img',]
    readonly_fields = ['image_img',]
# ---------------------------- end Gallery----------------------------------------------------------
class SpalniModelAdmin (admin.ModelAdmin):
   #  вывод всех полей в админку
   #    list_display = [field.name for field in Product._meta.fields]
   inlines = [SpalniImageInline,]
...
# Register your models here.
admin.site.register(SpalniModel,SpalniModelAdmin)
